...
import Item from '../pages/storePage/Items'
...
const Layout = () => {
  ...
  const search = useAppSelector(state => state.searchProducts.search)
    ...
    <>
      ...
      <Wrapper>
        ...
        <InnerWrapper>
          ...
          {
            search ? <Item name='Search' filter={search} search={true} /> : <Outlet />
          }
